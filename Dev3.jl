...
P_ij_min = Dict((1, 2) => -80.0, (2, 3) => -75.0, (2,5) => -40, (3, 4) => -130.0, (3, 6) => -40)  # Min power flow limits
P_ij_max = Dict((1, 2) => 80.0, (2, 3) => 75.0, (2,5) => 40, (3, 4) => 130.0, (3, 6) => 40)  # Max power flow limits
...
@objective(model, Min, sum(P_g[g] ^ 2 - c_g[g] * P_g[g] for g in G)+832)
...
CSV.write("optimization_results_Scen4.csv", results)
